...
#define CHANGE_INSETS (!IS_IPHONE && IOS_7)
...
if (CHANGE_INSETS) {
refreshBarButtonItem.imageInsets = UIEdgeInsetsMake(-20.0f, 0.0f, 0.0f, 0.0f);
}
...
if (CHANGE_INSETS) {
stopBarButtonItem.imageInsets = UIEdgeInsetsMake(-20.0f, 0.0f, 0.0f, 0.0f);
}
}
...
if (CHANGE_INSETS) {
actionBarButtonItem.imageInsets = UIEdgeInsetsMake(-20.0f, 0.0f, 0.0f, 0.0f);
}
}
...
- (void)startSpinner
{
[[NSNotificationCenter defaultCenter] postNotificationName:START_SPINNER object:nil];
}
